    ...
    <form @submit.prevent="submitForm" class="invoice-content">
      ...
      <div class="invoice-work flex flex-column">
        <div class="payment flex">
          ...
          <div class="input flex flex-column">
            <label for="paymentDueDate">Patment Due</label>
        ...
        <div class="work-items">
          ...
          <table class="item-list">
            ...
            <tr class="table-items flex" v-for="(item, index) in invoiceItemList" :key="index ">
              <th class="item-name"><input type="text" v-model="item.itemName"></th>
              <th class="qty"><input type="text" v-model="item.qty"></th>
              <th class="price"><input type="text" v-model="item.price"></th>
              <th class="total flex">${{ item.total = item.qty * item.price }}</th>
